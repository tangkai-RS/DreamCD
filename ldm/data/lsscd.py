...
class LsSCDTrain(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv="../data_changeanywhere2/DM/LsSCD-256/image_list.txt",
                         data_root="../data_changeanywhere2/DM/LsSCD-256",
                         segmentation_root="../data_changeanywhere2/DM/LsSCD-256",
                         size=size, random_crop=random_crop, interpolation=interpolation)
        

class LsSCDVal(SegmentationBase):
    def __init__(self, size=None, random_crop=False, interpolation="bicubic"):
        super().__init__(data_csv="../data_changeanywhere2/DM/LsSCD-256/image_list.txt",
                         data_root="../data_changeanywhere2/DM/LsSCD-256",
                         segmentation_root="../data_changeanywhere2/DM/LsSCD-256",
